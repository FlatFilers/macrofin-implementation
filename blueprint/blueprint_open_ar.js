export const blueprintOpenAR = [
    {
        name: "Open AR Template",
        slug: "open_ar/Open_AR_Template",
        access: ["*"],
        fields: [
          {
            key: "tranId",
          ...
          },
          {
            ...
            config: {
              key: "Name",
              ref: "open_ar/Subsidiary_NetSuite_Extract",
              relationship: "has-many",
            },
            readonly: false,
            constraints: [
          ...
          },
          {
            ...
            config: {
              key: "Name",
              ref: "open_ar/Currency_NetSuite_Extract",
              relationship: "has-many",
            },
            readonly: false,
            constraints: [
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            config: {
              key: "name",
              ref: "open_ar/Status_NetSuite_Extract",
              relationship: "has-many",
            },
            readonly: false,
            constraints: [
          ...
          },
          {
            ...
            config: {
              key: "name",
              ref: "open_ar/Customer_Category_NetSuite_Extract",
              relationship: "has-many",
            },
            readonly: false,
            constraints: [],
          ...
          },
          {
            ...
            config: {
              key: "State",
              ref: "open_ar/States_NetSuite_Extract",
              relationship: "has-many",
            },
            readonly: false,
            constraints: [],
          ...
          },
          {
            ...
            config: {
              key: "Countries",
              ref: "open_ar/Countries_NetSuite_Extract",
              relationship: "has-many",
            },
            readonly: false,
            constraints: [
          ...
          },
          {
            ...
            config: {
              key: "Account Name",
              ref: "open_ar/Chart_of_Accounts_NetSuite_Extract",
              relationship: "has-many",
            },
            readonly: false,
            constraints: [],
          ...
          },
          {
            ...
            config: {
              key: "description",
              ref: "open_ar/Terms_NetSuite_Extract",
              relationship: "has-many",
            },
            readonly: false,
            constraints: [],
        ...
        //     config: {
        //       key: "name",
        //       ref: "open_ar/Win_Project_Type_Values",
        //       relationship: "has-many",
        //     },
        //     readonly: false,
        //     constraints: [],
      ...
      },
      {
        ...
        slug: "open_ar/Subsidiary_NetSuite_Extract",
        access: ["*"],
        fields: [
          {
            key: "Internal_Id",
      ...
      },
      {
        ...
        slug: "open_ar/Currency_NetSuite_Extract",
        access: ["*"],
        fields: [
          {
            key: "Name",
      ...
      },
      {
        ...
        slug: "open_ar/Status_NetSuite_Extract",
        access: ["*"],
        fields: [
          {
            key: "internalID",
      ...
      },
      {
        ...
        slug: "open_ar/Customer_Category_NetSuite_Extract",
        access: ["*"],
        fields: [
          {
            key: "internalID",
      ...
      },
      {
        ...
        slug: "open_ar/States_NetSuite_Extract",
        access: ["*"],
        fields: [
          {
            key: "State",
      ...
      },
      {
        ...
        slug: "open_ar/Countries_NetSuite_Extract",
        access: ["*"],
        fields: [
          {
            key: "Countries",
      ...
      },
      {
        ...
        slug: "open_ar/Chart_of_Accounts_NetSuite_Extract",
        access: ["*"],
        fields: [
          {
            key: "internalID",
      ...
      },
      {
        ...
        slug: "open_ar/Terms_NetSuite_Extract",
        access: ["*"],
        fields: [
          {
            key: "description",
